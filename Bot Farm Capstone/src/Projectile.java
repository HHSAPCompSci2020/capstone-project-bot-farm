...
public class Projectile extends MovingImage{
	...
	public MovingImage act(ArrayList<MovingImage> list){
            //If owner is equal to "player", call "this.moveByAmount()" and move it by a negative number in the y direction.
            this.moveByAmount(stepX, stepY);
            //Else if owner is equal to "enemy", move it by a positive number in the y direction
