...
public class DrawingSurface extends PApplet implements MouseListener {
	...
	public DrawingSurface() { // Initializes every field, creating images and objects, adding them to the
								// list.
	...
	/**
	 * Draws all of the MovingImages in the list, and creates a hardcoded Start and
	 * game end HUD.
	 */
	public void draw() {
